...
import { handleError } from '../../util';
    ...
    function Testmainanlyse() {
        ...
        // cosnt [fastInspactionclicked2 ,setFastInspactionclicked2 ] = useState(false)
                ...
                <div className='shadow-2xl shadow-blue-500/20 max-h-[100%] rounded '>
                    <div className="container-fluid p-0 flex flex-grow  mb-4 w-[100%] gap-3 rounded ">
                        ...
                        <div className={`${selectedImage ? 'w-[30%]' : 'w-full'}`}>
                            ...
                            <Existingissue clicked={imageid} sendShapeDataGet={handleShapeDataFromChild} sendfastinspaction={handlefastInspactionfromchild}  updateissuestate={updateissuestate}  updateissuestatebyfalse={updatetofalse} />
