...
//            <div className="card p-4 shadow-lg w-100" style={{ maxWidth: '400px', position: 'relative', zIndex: 1 }}>
//                {/* <h1 className="text-center mb-4 text-black fw-bolder">Sign In</h1> */}

//                <div><h1 className='text-center'>Sign In</h1></div>
...
//                     <div className='font-bold text-gray-800 text-[20px]'>   <label className="form-label    ">Email Address</label></div>
//                        <input 
//                            type="email" 
...
//                    <div className="form-group mb-3">
//                     <div className='font-bold text-gray-800 text-[20px]'>  <label className="form-label text-black">Password</label> </div>
//                        <input 
//                            type="password" 
//                            className="form-control" 
...
//                    Don't have an account? <Link to="/signup" className="text-black ">Sign up here</Link>
//                </p>

//                {/* New section for Terms and Conditions and Contact links */}
//                <div className="text-center mt-3">
//                    <Link to="/terms" className="text-black me-3">Terms and Conditions</Link>
